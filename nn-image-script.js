    ...
    $( function() {
        $.fn.nn_iu = function( options ) {
            ...
            $( options.button ).click( function() {
                ...
                tb_show( 'Upload a logo', 'media-upload.php?referer=nn_iu&type=image&TB_iframe=true&post_id=0', false );
        ...
        // Usage
        $( '.upload' ).nn_iu(); // Use as default option.
    } );
} ( jQuery ) );
